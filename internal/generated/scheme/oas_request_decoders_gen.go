...
func (s *Server) decodeDialogUserIDSendPostRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptDialogUserIDSendPostReq
		if err := func() error {
			request.Reset()
...
func (s *Server) decodeUserRegisterPostRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptUserRegisterPostReq
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
